local Update = loadstring(Game:HttpGet"https://raw.githubusercontent.com/TurboLite/UI/refs/heads/main/Pc.lua")()
local Alert = loadstring(Game:HttpGet"https://raw.githubusercontent.com/TurboLite/UI/refs/heads/main/Pe.lua")()
local Library = Update:Window("Blox Fruits")
local Main = Library:Tab("Main","")
local Set = Library:Tab("Setting","")
local Hold = Library:Tab("Settings Skill","")
local M = Library:Tab("Items","")
local Sea = Library:Tab("Sea","")
local Ss = Library:Tab("Stats","")
local RaceV4 = Library:Tab("Race","")
local P = Library:Tab("Combat","")
local R = Library:Tab("Raid","")
local ESP = Library:Tab("Esp","")
local T = Library:Tab("Teleport","")
local S = Library:Tab("Shop","")
local D = Library:Tab("Devil Fruit","")
